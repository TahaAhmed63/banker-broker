...
function Base({ setpanel, getIncome }) {
  ...
  return (
    <>
      ...
      <h2 className="mt-4 Midle404"><b>Base Employment Income</b></h2>
      <div className="d-flex">
        ...
        <div class="form-check ms-1 ms-md-3">
          <input
            class="form-check-input rounded-0"
            type="checkbox"
            value=""
      ...
      <form action="" onSubmit={handleSubmit}>
        <div class="input-group mb-3">
          ...
          <input
            type="text"
            class="form-control Color404  rounded-0"
        ...
        {/* <div class="form-check my-2">
          ...
          /> */}
          {/* <label class="form-check-label rounded-0" for="CurrentEmployee">
            Current Employee?
          </label> */}
        {/* </div> */}
        {current === 1 ? (
          <div class="input-group mb-3" style={{height: "fit-content"}}>
            <span class="input-group-text rounded-0 hinpt mcx404" id="basic-addon1">
              Year in Profession
            </span>
            <input
              type="number"
              class="form-control Color404 hinpt  rounded-0"
              placeholder="Required"
              aria-label="Username"
              aria-describedby="basic-addon1"
        ...
        {fieldsError?.end_date
          ? fieldsError?.end_date.map((e) => <p className="text-danger">{e}</p>)
          : null}
        {/* <div class="input-group mb-3">
        ...
        <div class="form-check mt-4 mx-2">
          ...
          />
          <label class="form-check-label rounded-0" id="EmployText" for="Employed">
