...
const BackgroundTable = ({backgroundData}) => {
          ...
          <div className="col-md-12">
            <ThemeProvider theme={defaultMaterialTheme}>
              <MaterialTable
                icons={tableIcons}
                columns={[
                  { title: "Owning Money", field: "owning_money" },
                  { title: "Bankruptcy", field: "bankruptcy" },
                  { title: "How do you Find Property", field: "find_property" },
                  { title: "Additional Comments", field: "additional_comments" },
                ]}
                data={backgroundData?.map((e) => e)}
                actions={[
                  // {
